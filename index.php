	...
	<div id="servizi">
		<div class="flex-container">
			<div class="box six">
				...
				<ul>
					<li>1 immagine.....1€</li>
					<li>5 immagini.....3.5€</li>
					<li>10 immagini.....7€</li>
					<li>servizio fotografico.....12€/h</li>
					<li>+correzione colore.....1€</li>
					<li>+photoshop.....1.5€</li>
					<li>copertina album/libro....5€</li>
				</ul>
			</div>
			<div class="box seven">
				<h3>Editing</h3>
			...
			<div class="box nine">
				...
				<ul>
					<li>1 cartella.....2€</li>
					<li>10-30 cartelle.....1.5€ cad.</li>
					<li>>30 cartelle.....1€ cad.</li>
				</ul>
				<p>1500 caratteri/cartella</p>
			</div>
			<div class="box ten">
				<h3>Gadgets</h3>
				<p>Coming soon...</p>
